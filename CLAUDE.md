...
- **The LLM fallback (spec §4.7) was not built.** No private screenshot set
  exists yet to show the rule-based parser needs it. `POST /import/parse`
