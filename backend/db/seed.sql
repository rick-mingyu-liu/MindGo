...
BEGIN
    ...
    (user_id, 400.00, 'Grocery Shopping', 'Food & Dining', 'expense', '2025-03-05', 'CAD'),
    (user_id, 350.00, 'Grocery Shopping', 'Food & Dining', 'expense', '2025-04-05', 'CAD'),
    (user_id, 420.00, 'Grocery Shopping', 'Food & Dining', 'expense', '2025-05-05', 'CAD'),
    (user_id, 380.00, 'Grocery Shopping', 'Food & Dining', 'expense', '2025-06-05', 'CAD'),
