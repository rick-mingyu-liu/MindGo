...
Config: preset `v6-small`, engine `opencv`, strategy `per-line`. OCR time p50 211 ms, p95 339 ms (Node, cached runs keep their first timing).
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| bank-list | 24 | 24 | 164 / 163 | 100.0% | 99.4% | 100.0% | 77.3% | 100.0% | 95.1% | 100.0% | **0 (0.0%)** | 0 (0.0%) | 0 | 0 |
| receipt | 24 | 24 | 24 / 24 | 100.0% | 100.0% | 100.0% | 79.2% | 100.0% | 100.0% | 100.0% | **0 (0.0%)** | 0 (0.0%) | 0 | 0 |

**Overall:** 187/188 rows found, amounts exact 100.0%, silent amount errors 0 (0.0%), silent type errors 0, unflagged extra rows 0.
...
- wrong: expected `2026-09-14 144.84 expense AMAZON.CA`, got `null 144.84 expense AMAZON.CA 1` flags [type_guessed, missing_date, low_confidence]
- wrong: expected `2026-09-12 1999.83 income PAYROLL DEPOSIT`, got `null 1999.83 income PAYROLL DEPOSIT 3` flags [type_guessed, missing_date, low_confidence]
- missed: `2026-09-14 1694.74 income INTEREST PAID`
...
- wrong: expected `2026-09-11 28.86 expense DOLLARAMA`, got `null 28.86 expense DOLLARAMA` flags [arithmetic_verified, missing_date, low_confidence]
